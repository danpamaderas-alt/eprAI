...
const STATUS_COLORS: Record<string, string> = { 
  ...
  PARTIAL: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800', 
        ...
        <div className="border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-6 rounded-b-3xl space-y-6">
          ...
          <div className="flex flex-wrap justify-end gap-2 pb-4 border-b border-slate-200 dark:border-slate-700">
             <button 
                ...
                className="px-4 py-2 bg-transparent border-2 border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-400 rounded-xl text-[10px] font-black uppercase transition-all"
              >
                ✏️ Editar
              </button>
              ...
              <button 
                ...
                className="px-4 py-2 bg-transparent border-2 border-indigo-200 dark:border-indigo-800/50 text-indigo-600 dark:text-indigo-400 hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-xl text-[10px] font-black uppercase transition-all"
              >
                🏷️ Etiqueta
              </button>
...
export const OrdersDashboard = () => {
  ...
  return (
    <div className="animate-in fade-in duration-500 space-y-6">
      ...
      {/* 🏷️ ELEMENTO OCULTO PARA IMPRESIÓN (SIN DISPLAY NONE) */}
